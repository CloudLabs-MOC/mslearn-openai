...
- **Explore AI Agent development:** This hands-on lab focuses on creating and configuring an AI agent using the Microsoft Foundry portal to support employees with expense claims. You will set up a project, define the agent’s instructions, and ground its responses using an expense policy document. Finally, you will validate the solution in the playground by querying policy-related scenarios and generating a downloadable expense claim file for review.
